...
- Windows Subsystem for Linux and Virtual Machine Platform are enabled (This is done through Control Pannel > Programs > Turn on and off Windows Features).
...
- Nerd Fonts (I use JetBrainsMono Nerd Font) is installed on Windows. 
	POWERSHELL: 
